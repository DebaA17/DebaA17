...
<h3 align="center">🔐 DevSecOps & Penetration Tester | ☁️ Cloud & DevOps | 🎓 BCA Student (5th Sem)</h3>

<p align="center"><em>"Building scalable systems and securing them by design."</em></p>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?lines=DevSecOps%20%26%20Cloud%20Security;Penetration%20Testing;DevOps%20%26%20Automation;Continuous%20Security&center=true&width=500&height=45&color=58a6ff&vCenter=true&size=22" alt="Typing animation"/>
</p>
...
- 🎓 **BCA Student (3rd Year, 5th Semester)**
- 🔐 Focused on **Cybersecurity, Penetration Testing & Web Application Security**
- ⚙️ Specializing in **DevOps, Automation, & CI/CD Pipeline Hardening**
- ☁️ Designing secure **Cloud Infrastructure & Systems Security**
...
| 💡 Area | ⚒️ Focus |
|--------|--------|
| DevSecOps | Secure CI/CD pipelines, container scanning, IAM |
| Cybersecurity | Penetration testing, vulnerability research, system hardening |
| Cloud Security | Cloud platforms (AWS/GCP), secure networking, infrastructure as code |
| DevOps | CI/CD automation, Ansible configuration, Docker orchestration |
| Secure Development | Secure APIs, authentication workflows (MFA), scripting (Python/Go/Java) |
...
🌐 [Portfolio](https://debasisbiswas.in)  
